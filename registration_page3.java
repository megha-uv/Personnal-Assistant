...
public class Registration3
{
     Registration3()
     {
          ...
          l3.setSize(500, 150);
          k1.add(l3);
          JLabel l4 = new JLabel("WHAT'S YOUR EVENING BREAK TIME ?");
          ...
          d3.setLocation(1000,153);
          k1.add(d3);
          JLabel l5 = new JLabel("WHICH TIME DO YOU PREFER TO DO EXERCISE ?");
          ...
          k1.add(d4);
          JLabel l6 = new JLabel("WHICH TIME DO YOU HAVE YOUR COFFEE ?");
          ...
          k1.add(d5);
          JLabel l7 = new JLabel("WHICH TIME DO YOU PREFER TO HAVE YOUR DINNER?");
          ...
          k1.add(d6);
          JLabel l8 = new JLabel("WHICH TIME DO YOU PREFER TO GO TO BED ?");
